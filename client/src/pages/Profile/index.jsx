...
function Profile() {
    ...
    return ( <div>
        ...
        <div className="flex items-center justify-center min-h-screen" style={{ backgroundImage: "url('/bkb-logo.png')" }}>
    ...
    <div className="flex items-center justify-center min-h-screen ">
        <div className="card p-2 mt-2 w-50 br-3 flex text-black flex-col gap-1 uppercase">
            <div className="flex justify-between">
